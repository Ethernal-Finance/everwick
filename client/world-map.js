...
export const MAP={width:1000,height:1000,tile:16,spawn:{x:25,y:23},version:5};
...
export const PLACES={sunfield:{x:7,y:27},orchard:{x:10,y:12},mine:{x:45,y:10},forge:{x:42,y:19},tavern:{x:20,y:19},restaurant:{x:27,y:19},market:{x:33,y:28},workshop:{x:43,y:29},inn:{x:20,y:28},clinic:{x:27,y:28},warehouse:{x:35,y:37},garden:{x:11,y:37},barber:{x:13,y:19},tailor:{x:13,y:28},cobbler:{x:20,y:37},jeweler:{x:27,y:37}};
export const CIVIC=[{id:'hall',name:'Town Hall',x:32,y:13},{id:'bank',name:'Everwick Bank',x:35,y:19},{id:'watch',name:'Town Watch',x:24,y:10}];
...
const solid=new Set();for(const b of [...Object.values(PLACES),...CIVIC,...HOMES,...COTTAGES,...PARCELS])for(let y=b.y-2;y<b.y;y++)for(let x=b.x;x<b.x+4;x++)solid.add(`${x},${y}`);
